    ...
    return(
        <div>
            ...
            (show?
                ...
                <div className="container">
                        <div className="input_space">
                            <input placeholder="Name" id="1" type='text' ref={name} />
                        </div>
                        <div className="input_space">
                            <input placeholder="Email" id="2" type='text' ref={email} />
                        </div>
                        <div className="input_space">
                            <input placeholder="Password" id="3" type='password' ref={password} />
                        </div>
